...
//  fWS1ULogic->SetVisAttributes(G4VisAttributes::GetInvisible);
//  fWS1DLogic->SetVisAttributes(G4VisAttributes::GetInvisible);
//  fSC1ULogic->SetVisAttributes(G4VisAttributes::GetInvisible);
//  fSC1DLogic->SetVisAttributes(G4VisAttributes::GetInvisible); 
//  fWS2ULogic->SetVisAttributes(G4VisAttributes::GetInvisible);
//  fWS2DLogic->SetVisAttributes(G4VisAttributes::GetInvisible);
//  fALTULogic->SetVisAttributes(G4VisAttributes::GetInvisible);
