...
void A2PolarizedTarget::SetMagneticField(G4String &nameFileFieldMap)
{
  ...
  if(nameFileFieldMap=="") {G4cout<<"Warning A2PolarizedTarget::SetMagneticField No field map given, therefore there will be no field!"<<G4endl;return;}
...
//  SSOLogic->SetVisAttributes(G4VisAttributes::GetInvisible);
...
//  CUOLogic->SetVisAttributes(G4VisAttributes::GetInvisible);
...
//    NbTiCLogic->SetVisAttributes(G4VisAttributes::GetInvisible);
...
//    CUCLogic->SetVisAttributes(G4VisAttributes::GetInvisible);
...
//    EPCLogic->SetVisAttributes(G4VisAttributes::GetInvisible);
 }
 else if ( fTypeMagneticCoils == G4String("Saddle") || fTypeMagneticCoils == G4String("saddle") ) // The saddle coils
 {
   ...
   //  logicSaddleCoilsLayer1->SetVisAttributes(G4VisAttributes::GetInvisible);
   ...
   //  logicSaddleCoilsLayer2->SetVisAttributes(G4VisAttributes::GetInvisible);
 }
...
//  CUMALogic->SetVisAttributes(G4VisAttributes::GetInvisible);
...
//  CUMBLogic->SetVisAttributes(G4VisAttributes::GetInvisible);
...
//  CUMCLogic->SetVisAttributes(G4VisAttributes::GetInvisible);
...
//  SSIALogic->SetVisAttributes(G4VisAttributes::GetInvisible);
...
//  SSIBLogic->SetVisAttributes(G4VisAttributes::GetInvisible);
...
//  CUIALogic->SetVisAttributes(G4VisAttributes::GetInvisible);
...
//  CUIBLogic->SetVisAttributes(G4VisAttributes::GetInvisible);
...
//  CUICLogic->SetVisAttributes(G4VisAttributes::GetInvisible);
...
//  CUIDLogic->SetVisAttributes(G4VisAttributes::GetInvisible);
...
//  KAPALogic->SetVisAttributes(G4VisAttributes::GetInvisible);
...
//  KAPBLogic->SetVisAttributes(G4VisAttributes::GetInvisible);
...
//  KAPCLogic->SetVisAttributes(G4VisAttributes::GetInvisible);
...
//  KAPDLogic->SetVisAttributes(G4VisAttributes::GetInvisible);
...
//  BTRGTLogic->SetVisAttributes(G4VisAttributes::GetInvisible);
...
//  HEALogic->SetVisAttributes(G4VisAttributes::GetInvisible);
...
//  HEBLogic->SetVisAttributes(G4VisAttributes::GetInvisible);
...
//  HECLogic->SetVisAttributes(G4VisAttributes::GetInvisible);
...
//  HEDLogic->SetVisAttributes(G4VisAttributes::GetInvisible);
...
//  HEELogic->SetVisAttributes(G4VisAttributes::GetInvisible);
...
//  HEFLogic->SetVisAttributes(G4VisAttributes::GetInvisible);
...
//  TIOWLogic->SetVisAttributes(G4VisAttributes::GetInvisible);
...
//  CUOWLogic->SetVisAttributes(G4VisAttributes::GetInvisible);
...
//  ALOWLogic->SetVisAttributes(G4VisAttributes::GetInvisible);
...
//  ALIWLogic->SetVisAttributes(G4VisAttributes::GetInvisible);
...
//  CUBALogic->SetVisAttributes(G4VisAttributes::GetInvisible);
...
//  CUBBLogic->SetVisAttributes(G4VisAttributes::GetInvisible);
...
//  TIMWLogic->SetVisAttributes(G4VisAttributes::GetInvisible);
...
//  SSIWLogic->SetVisAttributes(G4VisAttributes::GetInvisible);
...
//  TIIWLogic->SetVisAttributes(G4VisAttributes::GetInvisible);
