...
// C target length:
  ...
  else if(fMaterial==G4NistManager::Instance()->FindOrBuildMaterial("A2_Li6"))trgt_length=0.01*cm; 
  else if(fMaterial==G4NistManager::Instance()->FindOrBuildMaterial("A2_Li7"))trgt_length=0.01*cm; 
